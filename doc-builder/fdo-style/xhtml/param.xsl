...
<!-- 0. Parameters for External Manipulation =================== -->
  ...
  <xsl:param name="homepage" select="'https://specifications.freedesktop.org/'"/>
    <!-- Override with:
...
<!-- 28. Style specific parameters =============================== -->
  ...
  <xsl:param name="daps.header.logo.text"></xsl:param>
  <xsl:param name="daps.header.logo.alt">Freedesktop Logo</xsl:param>
